...
internal enum Asset {
  ...
  internal static let background1 = ImageAsset(name: "background 1")
  ...
  internal static let splachFirst = ImageAsset(name: "splachFirst")
  internal static let splashSecond = ImageAsset(name: "splashSecond")
  internal static let sugar = ImageAsset(name: "sugar")
